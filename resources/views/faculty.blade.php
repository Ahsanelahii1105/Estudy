            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        ...
                        Their teaching style and methodology are very effective, helping my child understand complex
                        concepts
                    </div>
                ...
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        <h3 class="fas fa-quote-left text-primary mr-3"></h3>
                        Their experience and expertise help my child achieve their career goals.They regularly track my
                        child's progress
                    </div>
                    <div class="d-flex align-items-center">
                ...
                <div class="testimonial-item px-3">
                    <div class="bg-light shadow-sm rounded mb-4 p-4">
                        <h3 class="fas fa-quote-left text-primary mr-3"></h3>
                        My child feels comfortable with the faculty members and doesn't hesitate to ask questions & they are
                        very polite
                    </div>
                    <div class="d-flex align-items-center">
