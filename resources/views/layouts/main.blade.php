...
<body>
    ...
    <div class="container-fluid bg-light position-relative"
        style="width: 100%; height: 800px; background-image: url('img/library.jpg'); background-repeat: no-repeat; background-size: 100% 100%;">
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="/terms"><i class="fas fa-angle-right mr-2"></i>Terms And
                        Conditions</a>
                    <a class="text-white mb-2" href="/policy"><i class="fas fa-angle-right mr-2"></i>Privacy
                        Policy</a>
