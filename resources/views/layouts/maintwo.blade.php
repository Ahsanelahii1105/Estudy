...
@endif
<!-- Navbar Start -->
    <div class="container-fluid bg-light position-relative shadow"  style="width: 100%; height: 580px; background-image: url('img/library.jpg'); background-repeat: no-repeat; background-size: 100% 100%;">
      <nav
      ...
      >
        ...
        <button
          type="button"
          class="navbar-toggler clicktoggle"
